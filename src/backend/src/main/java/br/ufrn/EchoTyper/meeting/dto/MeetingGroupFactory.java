...
@Component
public class MeetingGroupFactory implements RegisterGroupFactory<MeetingGroup, Meeting> 
{

    @Override
    public MeetingGroup createGroup(Long id, String groupName, Set<Meeting> registers, JsonNode content) {
