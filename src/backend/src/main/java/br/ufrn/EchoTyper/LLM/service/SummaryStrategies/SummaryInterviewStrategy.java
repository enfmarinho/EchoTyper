...
public class SummaryInterviewStrategy implements SummaryStrategy {
    ...
    public String getContext(long id) {
        ...
        interviewService.getGroupContext(id).stream()
    ...
    public String buildSummaryPrompt(JsonNode payload) {
        ...
        return 
            ...
            A seguir, há resumos de entrevistas anteriores com outros candidatos para a mesma posição ou contexto, no formato JSON:
            %s
