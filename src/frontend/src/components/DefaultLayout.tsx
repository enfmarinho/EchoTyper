...
const menuItems = [
  ...
  { text: "Entrevistas", icon: <DescriptionIcon />,  url: `/dashboard/reunioes` },
    ...
    <Box sx={{ display: "flex" }}>
      ...
      >
        <Box sx={{ display: "flex", flexDirection: "column", alignItems: "center", p: 1 }}>
          <Image src="/logo-interview.jpg" alt="Logo" width={200} height={200} />
        </Box>
        <List>
        ...
        <Box sx={{ mt: "auto", p: 2 }}>
          <ListItemButton
            sx={{
              backgroundColor: "#245818",
              color: "white",
              borderRadius: 1,
              "&:hover": {
                backgroundColor: "#296d03",
              },
            }}
            component={Link}
            href="/login"
